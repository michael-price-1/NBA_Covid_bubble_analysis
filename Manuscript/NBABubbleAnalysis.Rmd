...
\emph{separate winning percentage from the other comparisons. Use
fisher.test for it}
...
tested using both a z-test and a nonparametric test. The Wilcoxon test will be used for shooting percentages and
Fisher's test will be used to test the binary variable of home team winning.
