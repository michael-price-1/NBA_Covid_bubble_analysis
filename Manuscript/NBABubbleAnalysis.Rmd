...
is no way replicate these effects in the bubble conditions. Also, there are 
...
normally discussed as a factor hurting away teams, but for the context of
...
by @Carron2005 is that in the absence of crowds result in overall performance increases.
...
fact, there is a growing consensus the three point shot is crucial because
...
to \citet{Harris}. In fact, 2020 NBA champion Los Angeles Lakers actually led league
...
due to the faster pace play and more common use of the three-point shot
...
advantage effects each team. The most effective way to do that is hypothesis
testing to compare performance in the neutral bubble to previous years with
normal game conditions for both the home and away team. Another potential
benefit of regression would have been the ability to control for factors
like strength of opponent. However, we felt that strength of team was
...
opponent strength is likely more important.
...
games. Around 1/3 of NBA games end by a decision of six points or less, those
...
to score a three pointer with the remaining six seconds. However, in the same scenario 
down six, you have no choice, but to foul. The free throws will likely put you down
seven or eight points, but the alternative is let the opponent run the 24 second shot 
...
a often at the ref's discretion to make the call, they'll likely miss and be credited the 
...
shooting because those fouls are more clear and less up to ref's discretion. Another possibility
...
cause the increase in away two-point shooting, but these are all possibilities. 
...
It's worth noting that much of this paper discussed the the effects from an
offensive point of view, focusing on a teams ability to score. However, one
of the main factors that influence an offense's ability to score is the opposing
...
noise of fans that hinder the away team's offensive efforts. This would also
...
noise from fans lowers level of play of away offense rather than raise the level
