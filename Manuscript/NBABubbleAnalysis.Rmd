...
for free throws. The z-test p-value of 0.0692 indictaes no significant difference, while
the Wilcoxon test p-value of 0.0469 indicates a difference at the 5% signficance level. Since,
the p-value of Wilcoxon test is so close to significance level and neither p-value is signifcant
...
for both the z-test and Wilcoxon test. Again, both p-values remain signficant after Bonferroni correction.
