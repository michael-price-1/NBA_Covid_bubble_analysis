...
\emph{Does this mean that the data for winning percentage are binary
(1/0)?}
...
\emph{Is shooting percentage the right terminology? It seems to mean
something else (google true shooting percentage)}
...
2017-2019, respectively. We considered both the $t$-test and the
Wilcoxon rank-sum test as implemented in R [@R]. The Wilcoxon rank-sum
test is preferred because, unlike the $t$-test, it is distribution-free.
The test will be conducted twice once comparing home scoring in 2020 to 2017-19 and once
comparing away scoring in 2020 to 2017-2019. 

\emph{What data were used for the test for the winning percentage?}
...
\emph{In the table, we have shooting rate and winning rate instead of
percentages. So remove the percentage sign and make sure consistency throughout}
