...
There were 83 games played in the 2020 playoffs. Giving us 83 observations 
for each variable in 2020 for both the home and away teams(166 observations total). 
Likewise, there were 243 games played over 2017-2019. Giving us 243 observations of each variable 
...
one winner and one loser making the outcome a binary variable. Each game has a winner 
denoted by a 1 in the W.L column of our data and a loser denoted by 0. Every game must result in 
exactly one team getting a 1 and exactly one team getting a 0. Winning percentage for home
(or away) teams can be conducted by summing the 1's for those teams together then dividing 
...
2017-2019, respectively. Or $p_1$ and $p_2$ are the home winning percentage for 2020 and
2017-2019, respectively. This proportion comes from summing the number of home teams wins
and dividing by the total number of games played.
...
where $\hat p$ is the pooled shooting percentage of 2017-2020. Or where $\hat p$ is the 
pooled home team winning percentage of 2017-2020.
