...
Tests for differences in proportions was conducted for comparing winning percentage of 
home teams in 2020 to those of 2017-2019. The null hypothesis is 
\[
H_0: p_1 = p_2,
\]
where $p_1$ and $p_2$ are the home winning percentage for 2020 and
2017-2019, respectively. $\hat{p}_1$ represents sample proportion for 2020 and $\hat{p}_2$ represents sample
proportion for 2017-2019. This proportion comes from summing the number of home teams wins
and dividing by the total number of games played. The test statistic is where $\hat p$ is the 
pooled home team winning percentage of 2017-2020. The null distribution of the test statistic is also standard normal.
This hypothesis will be tested using both a z-test and Fisher's test. Fisher's test is preferred, like Wilcoxon, 
because it is distribution free.

Tests for differences in proportions were also conducted for comparing shooting percentage on 
two-pointers, three-pointers and free throws for home and away teams in 2020 to those of 2017-2019. 
...
The test will be conducted six times, once for each of two-point shooting, three-point shooting and
free throws for both home and away teams in 2020 vs. 2017-2019. These hypotheses will also be
tested using both a z-test and the nonparametric Wilcoxon test.
...
z-test and 0.0400 for Fisher's test. The 95% confidence interval of (-0.255, -0.008) 
